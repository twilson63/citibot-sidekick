    ...
    <div class="hero-content">
      <div class="flex flex-col w-full md:min-w-[700px]">
        <div class="flex items-center justify-center relative">
          <img
            class="h-16 w-16"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdglLXTLM3Tbd5an65ob4Twvi8Bb0fkd5BXlWA82I&s"
            alt="citibot-logo"
          />
        </div>
        ...
        <h1 class="text-3xl font-mono text-center">Citibot Demo</h1>
        ...
        >
          <input
            ...
            placeholder="👋🏻 Ask me a question about the city?"
            required
          />
        ...
        <div class="mt-2 text-sm font-light font-mono text-center">
          ...
          <a class="link" href="https://citibot.io">Citibot</a>
        </div>
        <div class="mx-auto">
